...
import com.dzakyhdr.hollandbakeryserver.common.SpaceItemDecoration;
...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        categoryViewModel.getCategoryListMutable().observe(getViewLifecycleOwner(), categoryModelList -> {
            if (categoryModelList != null) { // dari ana
                dialog.dismiss();
...
//        dialog.show(); // remove it to fix loading when resume fragment
        ...
        MySwiperHelper mySwipeHelper = new MySwiperHelper(getContext(),recycler_menu,200) {
            @Override
            public void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MySwiperHelper.MyButton> buf) {
    ...
    private void showUpdateDialog() {
        ...
        View itemView = LayoutInflater.from(getContext()).inflate(R.layout.layout_update_categoty, null);
